...
class TextToImage:
    def __init__(self):
        ...
        self.image_button = tk.Button(self.root,
                                     text="Execute",
                                    font=("Times New Roman", 15),
                                    bg= "bisque", fg= "darkorange",
                                   width=20,
        ...
        self.close_button = tk.Button(self.root,
                                     text="X", 
    ...
    def print_image(self):
        images = self.model.text_to_image(self.entry.get(), batch_size=1, num_steps= 40)
